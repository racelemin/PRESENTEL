...
class CursograData {
	...
	public function update(){
		$sql = "update ".self::$tablename." set id_grado=\"$this->id_grado\",curso=\"$this->curso\" where id_gra_cu=$this->id";
		Executor::doit($sql);
	}
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CursograData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CursograData());
	}
